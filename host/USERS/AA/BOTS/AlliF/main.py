...
def load_config():
    global ADMIN_UID, BOT_NAME, OWNER_NAME, OWNER_TELEGRAM, HELP_MSG_1, HELP_MSG_2, ADMIN_MSG, ONLINE_MSG, EMOJI_MSG
    try:
...
MK_API_URL = "https://alliff-alliff-host.hf.space/proxy/5001"
GHOST_API_URL = "https://alliff-alliff-host.hf.space/proxy/5003/api/ghost"
LAG_GHOST_API_URL = "https://alliff-alliff-host.hf.space/proxy/5003/api/ghost_attack"
MSG_API_URL = "https://alliff-alliff-host.hf.space/proxy/5002"
SPAM_API_URL = "https://alliff-alliff-host.hf.space/proxy/5000"
...
async def handle_squad_with_id_command(squad_size, target_id, sender_uid, current_chat_type, current_chat_id, key, iv, region):
    try:
        ...
        P = await SEndMsG(current_chat_type, f"[B][C][FF0000]❌ ERORR", sender_uid, current_chat_id, key, iv)
        await SEndPacKeT(whisper_writer, online_writer, 'ChaT', P)
        return False
